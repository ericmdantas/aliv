...
module.exports = class Server {
  constructor(opts) {
    ...
    this.alivrcPath = this.root + '/.alivrc';
  ...
  _findIndexPath() {
    if (this.opts.pathIndex.length) {
      this.indexHtmlPath = this.root + '/' + this.opts.pathIndex + '/index.html';
    }
    else {
      this.indexHtmlPath = this.root + '/index.html';
    }
  }
