...
module.exports = class Server extends EventEmitter {
  ...
  _createServer() {
    ...
    if (this.opts.http2 || this.opts.secure) {
      let port = 80 // TODO : this should be this.opts.httpPort or this.opts.insecurePort & 80 by default if none provided
      console.info('will redirect http (' + port + ') traffic to https (' + this.opts.port + ')');
